...
const AutoRun = () => {
    ...
    return (
        <div className="container mx-auto my-10 px-4 my-animation">
            <div className="flex items-center gap-0 bg-white shadow-[0_8px_30_rgb(0,0,0,0.04)] border border-gray-100 rounded-2xl overflow-hidden py-1 pr-4">


                <div className="relative px-6 py-3 bg-gradient-to-r from-red-600 to-rose-500 text-white font-bold text-sm uppercase tracking-wider flex items-center justify-center shrink-0 shadow-lg z-10 animate-pulse">
